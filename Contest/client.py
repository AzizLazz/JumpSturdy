...
if is_player_two:
        ...
        # Player 1 (AI)
            ...
            print("New Board: " + game["board"])
            # Send current game state to AI and get the move
            #game_state = {"fen": game["board"], "currentPlayer": "b"}
            print("Warning: Received empty game data" )
            #move = send_game_state_to_ai(game_state)
